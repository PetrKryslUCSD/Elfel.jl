...
"""
module stokes_driven_tht6_veclap
...
function run()
    ...
    vtkwrite("stokes_driven_tht6_veclap-p", baseincrel(pmesh), [(name = "p",), ])
    vtkwrite("stokes_driven_tht6_veclap-v", baseincrel(vmesh), [(name = "ux",), (name = "uy",)])
end

end

stokes_driven_tht6_veclap.run()
