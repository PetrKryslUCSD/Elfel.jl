...
function run()
    ...
    vtkwrite("stokes_driven_q4_irreg-p", baseincrel(mesh), [(name = "p",), ])
    vtkwrite("stokes_driven_q4_irreg-v", baseincrel(mesh), [(name = "ux",), (name = "uy",)])
    true
end

end

stokes_driven_q4_irreg.run()
